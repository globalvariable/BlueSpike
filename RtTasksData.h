...
#define BLUE_SPIKE_BUFF_HANDLER_PERIOD 						KERNELSPIKE_PERIOD		//1 ms
...
#define TRIAL_HAND_2_NEURAL_NET_MSGS_HANDLER_PERIOD 					KERNELSPIKE_PERIOD		//1 ms
...
// Trial Handler 2 Neural Network Messages Handler
#define TRIAL_HAND_2_SPIKE_GEN_MSGS_HANDLER_PERIOD 					KERNELSPIKE_PERIOD		//1 ms
#define TRIAL_HAND_2_SPIKE_GEN_MSGS_HANDLER_TASK_NAME				nam2num("TRTOSG")
#define TRIAL_HAND_2_SPIKE_GEN_MSGS_HANDLER_TASK_PRIORITY				102
...
// SpikeGenerator
#define SPIKE_GENERATOR_PERIOD 						KERNELSPIKE_PERIOD		//1 ms
