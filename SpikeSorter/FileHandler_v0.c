...
int write_template_matching_data_v0(int num, ...)
{
	...
	printf ("sizeof(TemplateMatchingData) = %lu", sizeof(TemplateMatchingData));
...
int read_template_matching_data_v0(int num, ...)
{
	...
	TemplateMatchingData	*template_matching_data, *local_template_matching_data;
	char *path;	
	char path_bin[600];	
	char message[500];
	char line[300];
	...
	local_template_matching_data = g_new0(TemplateMatchingData,1);
	...
	g_free(local_template_matching_data);
