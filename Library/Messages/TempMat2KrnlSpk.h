...
#define TEMPLATE_MATCHING_2_KERNEL_SPIKE_MSG_SET_ALARM_THRES			6
#define TEMPLATE_MATCHING_2_KERNEL_SPIKE_MSG_SET_UNIT_ALARM_OFF			7
#define TEMPLATE_MATCHING_2_KERNEL_SPIKE_MSG_SET_UNIT_ALARM_ON			8
#define TEMPLATE_MATCHING_2_KERNEL_SPIKE_MSG_RESET_UNIT_ALARM			9
#define TEMPLATE_MATCHING_2_KERNEL_SPIKE_MSG_RESET_ALL_ALARM			10
