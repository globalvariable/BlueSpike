...
int write_config_daq_data_v0(int num, ...)
{
	...
	if ((fp = fopen("ConfigDaq/path_initial_directory", "r")) == NULL)  { print_message(ERROR_MSG ,"ConfigDaq", "FileHandler", "write_config_daq_data_v0", "Couldn' t read ConfigDaq/path_initial_directory."); return 0; }
	fclose(fp);
	if ((fp = fopen("ConfigDaq/path_initial_directory", "w")) == NULL)  { print_message(ERROR_MSG ,"ConfigDaq", "FileHandler", "write_config_daq_data_v0", "Couldn' t write to ConfigDaq/path_initial_directory."); return 0; }
	fprintf(fp, "%s", path); 
	fclose (fp);	
